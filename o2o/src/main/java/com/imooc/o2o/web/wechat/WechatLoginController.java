...
public class WechatLoginController {
    @Resource
    private com.imooc.o2o.service.WechatAuthService wechatAuthService;
    @Resource
    ...
    public String doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        // ======todo begin======
        if(auth==null){
        Person person  = WechatUtil.getPersonInfoFromRequest(user);
        auth=new WechatAuth();
        ...
        auth.setPersonInfo(person);
            ...
            if(we.getState()!= WechatAuthStateEnum.SUCCESS.getState()){
                ...
                person = personInfoService.getPersonInfoById(auth.getPersonInfo().getUserId());
